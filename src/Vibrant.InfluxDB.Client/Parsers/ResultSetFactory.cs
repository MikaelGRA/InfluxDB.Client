...
namespace Vibrant.InfluxDB.Client.Parsers
{
   internal static class ResultSetFactory
   {
      ...
      //internal static Task<InfluxResultSet<TInfluxRow>> CreateAsync<TInfluxRow>(
      //   InfluxClient client,
      //   JsonStreamObjectIterator iterator,
      //   string db,
      //   TimestampPrecision? precision,
      //   bool allowMetadataQuerying,
      //   TimeSpan? metadataExpiration )
      ...
      //   if( IsIInfluxRow<TInfluxRow>() )
      //   {
      //      return CreateBasedOnInterfaceAsync<TInfluxRow>( client, iterator, db, precision, allowMetadataQuerying, metadataExpiration );
      //   }
      //   else
      //   {
      //      return Task.FromResult( CreateBasedOnAttributes<TInfluxRow>( iterator, precision ) );
      //   }
      //}

      //private static InfluxResultSet<TInfluxRow> CreateBasedOnAttributes<TInfluxRow>(
      //   JsonStreamObjectIterator objectIterator,
      //   TimestampPrecision? precision )
      //   where TInfluxRow : new()
      //{
      //   QueryResult queryResult = null;
      //   if( ( queryResult = objectIterator.ReadNext<QueryResult>() ) != null )
      //   {
      ...
      //   InfluxClient client,
      //   JsonStreamObjectIterator queryResults,
      //   string db,
      //   TimestampPrecision? precision,
      //   bool allowMetadataQuerying,
      //   TimeSpan? metadataExpiration )
      ...
      //   if( ( queryResult = queryResults.ReadNext<QueryResult>() ) != null )
      //   {
